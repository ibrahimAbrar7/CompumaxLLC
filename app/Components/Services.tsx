...
const Services: React.FC = () => {
  return (
    <div className="w-full py-16 bg-gray-300 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center text-[#101a54] dark:text-gray-300 mb-12">Our Services</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Service 1: Website Designing */}
          <div className="w-full p-6 bg-gradient-to-r from-[#1f648a] via-[#80a6ca] to-[#6356a5] text-white dark:text-gray-900  text-center rounded-lg">
